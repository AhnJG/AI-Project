"""
Description : Create the train-test split
Usage : python splitTrainAndTest.py /data-ssd/sunita/snowman/JPEGImages
Give the correct path to the data JPEGImages folder. 
